...
K.options = {
	...
	htmlTags : {
		...
		video : ['id', 'class', 'src', 'width', 'height','controls','poster','preload', 'type', 'loop', 'autostart', 'quality', '.width', '.height', 'align', 'allowscriptaccess', 'wmode'],
...
KindEditor.plugin('filemanager', function(K) {
	...
	self.plugin.filemanagerDialog = function(options) {
		...
		function reloadPage(path, order, func) {
			var param = 'path=' + path + '&order=' + order + '&file=' + dirName;
